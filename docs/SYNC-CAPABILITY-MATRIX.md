...
| Labels and URLs | Structural reads only | Authoring destination unsupported | Complete typed reads | Exact creation; mapped content update remains blocked | Partial preview |
