...
| Package distribution | Verified from local release tarballs | A clean Node project installed `moodle-core-cli@0.3.0`, `moodlia@0.3.0`, and `moodlia-sync-mcp@0.1.0`; all public exports and four executables loaded, and `npm audit --audit-level=high` reported zero vulnerabilities |
